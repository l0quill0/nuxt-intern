...
<template>
  <div
    class="flex pt-[50px] h-full xl:flex-row flex-col p-2.5 w-full xl:w-auto items-center xl:items-start"
  >
    ...
    <div
      class="max-w-[1110px] w-full flex flex-col items-center pt-[30px] gap-[30px] grow h-full"
    >
