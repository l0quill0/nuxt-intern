...
<template>
  <div class="w-full flex flex-col items-center">
    <h2 class="text-3xl font-bold pt-12" v-if="data?.length">Улюблене</h2>
    <div
    ...
    >
      ...
      <NuxtImg src="../public/broken-heart-icon.png" v-if="!data?.length" />
      <div
        v-if="data"
